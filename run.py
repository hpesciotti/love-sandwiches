...
def get_sales_data():
    ...
    while True:
        ...
        data_str = input("Enter your data here:\n") #Got to insert the line break symbol for it to work properly
...
def update_worksheet(data, worksheet):
    """
    Update X worksheet. reafactor funciton
    """
...
def calculate_surplus_data(sales_row):
    ...
    The surplus is defined as the sales figure subtrackes from the stock:
    - Posituve surplus indicates waste
    - Negative surplus indicates extra made whe stock was sold out.
    """
